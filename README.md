...
This phase contains content, validation and media automation only. The Astro/React static-site frontend described in the design specification has not been implemented yet.
...
Ten etap nie zawiera jeszcze frontendu strony. Obejmuje treść, walidację i automatyzację mediów; statyczny frontend Astro/React jest opisany w specyfikacji jako następny etap.
